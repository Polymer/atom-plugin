...
class TooltipManager extends Disposable {
    ...
    calculatePositions(event, textEditorElement) {
        ...
        const nearColumn = Math.abs(currentCursorPixelPosition.left - expectedPixelPosition.left) <
            20;
        const nearRow = Math.abs(currentCursorPixelPosition.top - expectedPixelPosition.top) <
            20;
